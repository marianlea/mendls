...
export default function Checkout({ basket }) {
  ...
  async function handleCheckout() {
    const stripe = await loadStripe(
      "pk_test_51OppwUJMehcHOqCV1mz7CJJ99LZcVSOW6YZyX5GAvm6XVzQfZNpDUpBGF30PeezQPTVUjAXe3NN1q6kPifL2U3uY00sJ4OQIce"
    );
    ...
    const response = await fetch(
      "https://mendls-server.vercel.app/api/create-checkout-session",
      {
        method: "POST",
        headers: headers,
